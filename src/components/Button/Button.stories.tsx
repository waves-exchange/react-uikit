    ...
    <ThemeProvider theme={defaultTheme}>
        <Flex flexDirection="row" p="16">
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="large">Secondary</Button>
            ...
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="medium">Secondary</Button>
            ...
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="small">Secondary</Button>
            ...
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="potty">Secondary</Button>
            ...
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="micro">Secondary</Button>
    ...
    <ThemeProvider theme={defaultTheme}>
        <Flex flexDirection="row" p="16">
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="large" disabled={true}>Secondary</Button>
            ...
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="medium" disabled={true}>Secondary</Button>
            ...
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="small" disabled={true}>Secondary</Button>
            ...
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="potty" disabled={true}>Secondary</Button>
            ...
            <Flex flexDirection="column" mr="16">
                ...
                <Button mb="16" variant="danger" size="micro" disabled={true}>Secondary</Button>
